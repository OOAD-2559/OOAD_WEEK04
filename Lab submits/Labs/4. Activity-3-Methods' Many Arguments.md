...
เกิด Error แก้ไขโดยการเพิ่ม constructor string gender = "m" เนื่องจากเราได้ใส่ double hourlySalary = 500.00D แต่ไม่รู้ว่าพารามิเตอร์ gender ควรใส่อะไรจึงเกิด error
