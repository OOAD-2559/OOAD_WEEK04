...
จากการรันจะพบว่า มีการรีเทอนค่ากับมาเป็น 0.0 แต่ใน Main แปลงค่าเป็น string
...
จากโปรแกรมพบว่า มีการรับค่า(10, 20); ที่ส่งไป จากนั้นคำนวน Width * Height; แล้วจึงส่งกลับมา
...
มีการคำนวนและส่งค่ากลับมาตรงๆ (return Width * Height;)
...
จากการรัน พบว่าคลาสไม่มีส่วนของbody แต่จะรับค่าw, h; โดยตรงเลย 