...
จากการรันพบว่าโปรแกรมมีการแสดงข้อมูลต่างๆของออฟเจค exo โดยการแอดข้อมูลของออฟเจคนี้นั้นจะทำการแอดพร้อมกันที่เดียวใน main และมีเมดธอด void ShowEmployee(int employeeNumber, string fullName, string gender, double hourlySalary) รับค่าทั้งหมดนั้นไว้
...
จากการรันพบว่าโปรแกรมนั้น error exo.ShowEmployee(572948, "Sommai Jaisoo"); 
เนื่องจาก int employeeNumber, string fullName, string gender, double hourlySalary = 500.00D) 
นั้นรับพารามิตเตอร์ อย่างน้อย3 ตัว แต่ในบรรทัดดังกล่าวมีการใส่พารามิตเตอร์มาแค่2จึง error 
โดยในexo.ShowEmployee(572948, "Somchai Jaided", "M"); ไม่ต้องระบุ hourlySalary ก็ได้เนื่องจากในคลาสได้กำหนดค่าไว้ให้แล้ว (hourlySalary = 500.00D)

การแก้ไขคือเพิ่มพาลามิตเตอร์ให้ครบ3ตัว
...
จากการรันพบว่าข้อมูลที่แอดไปนั้นสามารถใช้งานได้ สรุปได้ว่าหากต้องการแอดข้อมูลไม่จำเป็นต้องตามลำดับแต่ต้องระบุชนิดตัวแปลที่ต้องการแอดก่อนแล้วแอดข้อมูล
เช่น fullName: "Somsri Jaiorn"
จะเห็นว่า fullName เป็นชื่อที่ต้องการแอดข้อมูล และ 
Somsri Jaiorn เป็นข้อมูที่ต้องการแอด โดยไม่สนลำดับในการแอด
