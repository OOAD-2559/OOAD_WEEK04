...
```
ไม่สามารถรันได้ เนื่องจาก Method Area ไม่มีการรับค่าพารามิเตอร์ใด ๆ และไม่มีการ Declare ตัวแปร Width และ Height อีกทั้งในการเรียกใช้ Method จาก Main ยังมีการระบุพารามิเตอร์ซึ่ง Method Area ไม่ต้องการ นอกจากนี้ Method Area ยังไม่ได้เป็น Static Method จึงไม่สามารถเรียกใช้งานได้จาก Main

สามารถแก้ไขได้โดยการเพิ่ม Parameter ให้แก่ Method Area และทำให้ Method นี้ เป็น Static Method
```
