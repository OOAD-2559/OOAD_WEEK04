...
หากต้องการแก้ไข สามารถทำได้โดยเพิ่มค่า default ให้แก่พารามิเตอร์ลำดับที่ 3 หรือระบุค่าพารามิเตอร์ในการเรียกใช้ให้ครบอย่างน้อย 3 ลำดับแรก
```
...
```
มีการแสดงผลเหมือนกันเนื่องจากมีการระบุค่าพารามิเตอร์เพียง 3 ค่า ทั้งสองการเรียกใช้ Method
```
![act3-3](imgs/act3-3.PNG)
